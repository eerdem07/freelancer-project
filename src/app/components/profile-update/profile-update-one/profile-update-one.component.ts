...
@Component({
  selector: 'app-profile-update-one',
  templateUrl: './profile-update-one.component.html',
  styleUrls: ['./profile-update-one.component.scss']
})
export class ProfileUpdateOneComponent implements OnInit {
 ...
 listSubCategory2(){
  ...
  updateProfile(category:any, subcategory:any, subcategory2:any, ozgecmis:any, university:any){
